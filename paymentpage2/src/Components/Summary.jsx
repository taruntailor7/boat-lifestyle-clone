...
<Box style={{display:"flex",gap:"40px",overflowY:"scroll",height:"90px"}}>
           ...
           {/* button box */}
           <Box sx={{display:"flex",gap:"280px",position:"absolute",width:"",boxShadow: "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px",height:"60px",alignItems:"center",position:"absolute",zIndex:"9",marginTop:"30px"}}>
            <Box fontSize={20}>₹1600</Box>
