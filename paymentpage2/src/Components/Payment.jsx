...
<Box style={{display:"flex",gap:"5px",marginBottom:"20px",}}>
    ...
    <Box style={{fontSize:"25px",marginBottom:"20px",boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px",padding:"5px",justifyContent:"space-around",display:"flex"}}><Box><BiHappyAlt/></Box>Proceed to buy the product</Box>
