...
export const ShopByCategory = () => {   
    ...
    return (
        <Box width="100%" margin="auto" marginTop={{base:"70px",sm:"30px",md:"40px",lg:"70px"}}>
            ...
            {categoryData.map((cat)=>(
                <NavLink key={cat.id} to={`/collections/${cat.id}/${cat.url}`} >
                    <Box w="100%" textAlign="center" position="relative">
                        <Box w="54%" margin="auto" bg='#e3e3e3' height="38px" borderRadius="10px" position="absolute" top={{base:"59px",sm:"72px",md:"69px",lg:"59px"}} left="0" right="0" zIndex="-1">
